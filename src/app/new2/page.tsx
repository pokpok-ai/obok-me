...
import { WatercolorMapContainer } from "@/components/maplibre/WatercolorMapContainer";
import { TransactionMarkers } from "@/components/maplibre/TransactionMarkers";
import { HeatmapLayer } from "@/components/maplibre/HeatmapLayer";
import { FilterBar } from "@/components/maplibre/FilterBar";
...
export default function WatercolorMapPage() {
  ...
  return (
    <main className="h-screen w-screen relative overflow-hidden">
      ...
      />
      <WatercolorMapContainer onBoundsChanged={handleBoundsChanged} center={mapCenter} zoom={mapZoom}>
        {!heatmapEnabled && (
          <TransactionMarkers
            transactions={transactions}
            focusedTransaction={focusedTransaction}
            onFocusConsumed={() => setFocusedTransaction(null)}
