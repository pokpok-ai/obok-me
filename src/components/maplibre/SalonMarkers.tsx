...
const GBAR_SALONS: GBarSalon[] = [
  ...
  {
    name: "G x Bar Hip",
    address: "Warszawa, Marszałkowska 32, 00-554",
    phone: "+48512874333",
    lat: 52.2282,
    lng: 21.0153,
    slug: "g-x-bar-hip",
  ...
  {
    name: "GxBar Well",
    address: "Franciszka Klimczaka 17, 02-797, Warszawa",
    phone: "+48574874334",
    lat: 52.1774,
    lng: 21.0284,
    slug: "gxbar-well",
          ...
          <div style={{ padding: 4, minWidth: 220, maxWidth: 280, position: "relative", paddingRight: 24 }}>
            ...
            {selected.phone && (
              <div style={{ fontSize: 14, color: "#4b5563", marginBottom: 12 }}>
                <a href={`tel:${selected.phone}`} style={{ color: "#2563eb", textDecoration: "underline" }}>
                  {selected.phone}
                </a>
              </div>
            )}
